...
type
  ...
  public const
    ...
    //AI ASSISTANT (MCP)
    MENU_IDE_AI_ASSISTANT_NAME = 'C4DWizarAIAssistant1';
    MENU_IDE_AI_ASSISTANT_CAPTION = 'AI Assistant (MCP)';
    MENU_IDE_AI_ASSISTANT_OPEN_NAME = 'C4DWizarAIAssistantOpen1';
    MENU_IDE_AI_ASSISTANT_OPEN_CAPTION = 'Open AI Assistant...';
    MENU_IDE_AI_ASSISTANT_REFRESH_NAME = 'C4DWizarAIAssistantRefreshTools1';
    MENU_IDE_AI_ASSISTANT_REFRESH_CAPTION = 'Refresh MCP Tools';
    MCP_DEFAULT_SERVER_URL = 'http://localhost:8080/mcp';
