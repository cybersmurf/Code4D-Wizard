...
type
  ...
  public
    ...
    class procedure AIAssistantClick(Sender: TObject);
    class procedure AIAssistantRefreshToolsClick(Sender: TObject);
  end;
...
class procedure TC4DWizardIDEMainMenuClicks.AIAssistantClick(Sender: TObject);
var
  LView: TC4DWizardAIAssistantView;
begin
  LView := TC4DWizardAIAssistantView.Create(nil);
  try
    LView.ShowModal;
  finally
    FreeAndNil(LView);
...
class procedure TC4DWizardIDEMainMenuClicks.AIAssistantRefreshToolsClick(Sender: TObject);
begin
  TC4DWizardIDEMainMenuClicks.AIAssistantClick(Sender);
end;
